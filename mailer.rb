...
@str_2 = "\" width=\"595\">
        ...
        <tr height=\"25\">
          ...
          <td>
            <strong>
              <font face=\"helvetica\" size=\"6\" color=\"white\">&iexcl;Hola!</font>
            </strong>
          </td>
        </tr>
        <tr height=\"65\">
...
@str_3 = " quiere compartirte como se siente hoy #EnAldeaDigital
          </font></td>
        </tr>
        <tr>
          <td width=\"40\"></td>
...
def get_nube(nubecita)
  case nubecita
    when 0
      str_nube = "http://72f7ed2ed9a20d512140-172f54d3400a9a3a895a0038338de347.r79.cf2.rackcdn.com/email/enamorado.png"
    when 1
      str_nube = "http://72f7ed2ed9a20d512140-172f54d3400a9a3a895a0038338de347.r79.cf2.rackcdn.com/email/feliz.png"
    when 2
      str_nube = "http://72f7ed2ed9a20d512140-172f54d3400a9a3a895a0038338de347.r79.cf2.rackcdn.com/email/indiferente.png"
    when 3
      str_nube = "http://72f7ed2ed9a20d512140-172f54d3400a9a3a895a0038338de347.r79.cf2.rackcdn.com/email/inteligente.png"
    when 4
      str_nube = "http://72f7ed2ed9a20d512140-172f54d3400a9a3a895a0038338de347.r79.cf2.rackcdn.com/email/radiante.png"
    when 5
      str_nube = "http://72f7ed2ed9a20d512140-172f54d3400a9a3a895a0038338de347.r79.cf2.rackcdn.com/email/sorprendido.png"
    else 
...
def send_mail(mail_list, str_name, name)
  Mail.deliver do
    from     'La Nube #EnAldeaDigital'
    to       mail_list
    subject  '#EnAldeaDigital'
    html_part do
